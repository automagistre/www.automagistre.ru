...
const workSec = () => {
  ...
  const secWorkSlider = document.getElementById('sec-work-slider');
  const workFilterBtn = secWorkNode.querySelectorAll('.js-work-filter');
  const workCounter = secWorkNode.querySelector('#sec-work-count');
